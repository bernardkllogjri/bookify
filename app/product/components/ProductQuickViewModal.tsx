...
const ProductQuickViewModal: FC  = () => {
  const product = useProductsStore.use.selectedProduct();
  ...
  const closeQuickView = useAppStore.use.closeQuickView();
  const quickViewOpen = useAppStore.use.quickViewOpen();
                        ...
                        >
                          ...
                          <div className="mt-6">
                            ...
                            <div className="flex items-center">
                              ...
                              >
                                {product.totalReviews?.count} reviews
                              </a>
                            </div>
                          </div>
                        </section>
